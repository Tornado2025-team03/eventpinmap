...
const faqs = [
  {
    ...
    answer:
      "A. このアプリは、大学生や若手社会人が「行動の壁」を越えて気軽にイベントへ参加・開催できるアプリです。主催者側はイベント作成を手軽にできるようにし、参加者側は地図上からイベントを簡単に探せます。また、自分の暇な場所、暇な時間に合わせて、イベントに誘ってもらえます。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "A. 「見る」タブから参加したいイベントの詳細ページにある「予約する」ボタンをタップすると予約が完了します。予約したイベントは「予約一覧」タブからご確認いただけます。",
  },
  {
...
const supportEmail = "himappu.contact@gmail.com";
